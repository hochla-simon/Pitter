...
if (!empty($images)) {
    ...
    if($count!=0){
        ...
        <div class="slideshow_commands">
            <img id="slideshow_previous" class="command_icon" src="<?php echo $config['projectURL']?>images/caret-left.svg" alt="previous icon">
            <img id="slideshow_pause" class="command_icon" src="<?php echo $config['projectURL']?>images/media-pause.svg" alt="pause icon">
            <img id="slideshow_play" class="command_icon hidden" src="<?php echo $config['projectURL']?>images/media-play.svg" alt="play icon">
            <img id="slideshow_next" class="command_icon" src="<?php echo $config['projectURL']?>images/caret-right.svg" alt="next icon">
        </div>
